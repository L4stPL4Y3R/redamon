...
- [readmes/coding_agent_prompts/PROMPT.ADD_PARTIAL_RECON.md](../../readmes/coding_agent_prompts/PROMPT.ADD_PARTIAL_RECON.md) - full walkthrough, modal UI, input validation, reference impls
